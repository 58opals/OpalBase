...
struct EllipticCurveDigitalSignatureSchnorrBitcoinCashValidator {
    ...
    func schnorrBchTransactionBuildsWithSchnorrSignature() throws {
        ...
        let recipientOutputs = [OpalBase.Transaction.OutputModel(value: 4_000, lockingScript: lockingScript)]
        let changeOutput = OpalBase.Transaction.OutputModel(value: 6_000, lockingScript: lockingScript)
