...
private extension AddressBookUnspentTransactionOutputSelectionValidator {
    ...
    func makeTokenData(from fixture: TokenPrefixTokenData) throws -> CashTokens.TokenData {
    ...
    func makeNonFungibleToken(from fixture: TokenPrefixNonFungibleTokenData) throws -> CashTokens.NFT {
