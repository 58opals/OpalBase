...
extension ECDSATests {
    ...
    @Test func testECDSASignatureAndVerification() throws {
        ...
        let derSignature = try ECDSA.sign(message: message, with: privateKey, in: .ecdsa(.der))
    ...
    @Test func testSchnorrSignatureAndVerification() throws {
        ...
        let schnorrSignature = try ECDSA.sign(message: message, with: privateKey, in: .schnorr)
