...
enum BitcoinCashMetadataRegistryTestData {
    enum FixtureError: Error {
        case invalidRegistryIconLocation
    }
    ...
    static var publicationHash: Data {
        get throws { try makeData(from: publicationHashHexadecimal) }
    }
    ...
    static var registryHash: Data {
        get throws { try makeData(from: registryHashHexadecimal) }
    }
    ...
    static var publicationScript: Data {
        get throws {
            ...
            script.append(Data.push(try publicationHash))
    ...
    static var categoryIdentifier: OpalBase.CashTokens.CategoryID {
        get throws { try OpalBase.CashTokens.CategoryID(hexFromRPC: categoryHexadecimal) }
    }
    
    static var registryIconLocation: URL {
        get throws {
            guard let url = URL(string: "https://example.com/icon.png") else {
                throw FixtureError.invalidRegistryIconLocation
            }
            return url
        }
    }
    
    private static func makeData(from hexadecimalString: String) throws -> Data {
        try Data(hexadecimalString: hexadecimalString)
    }
}
