...
func makeClaimablePrivateKey(lastByte: UInt8) -> Data {
    Data(repeating: 0, count: 31) + Data([lastByte])
}

func makeClaimableDestinationLockingScript(fillByte: UInt8 = 0x33) -> Data {
...
func makeClaimableHistoryEntry(
...
func makeClaimableScriptHashReader(
...
func makeClaimableTransactionReader(
...
func makeClaimableFundingTransaction(
    for envelope: OpalBase.Claimable.Envelope,
...
func decodeClaimableUnlockingScript(
...
func readClaimableTestPushedElement(
    from bytes: [UInt8],
    offset: inout Int
) throws -> Data {
    guard offset < bytes.count else {
