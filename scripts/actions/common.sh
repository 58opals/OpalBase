...
OPALBASE_LIVE_TEST_SPECIFIERS=(
  "OpalBaseTests\\.NetworkFulcrum"
  "OpalBaseTests\\.AddressBookUTXORefreshNetworkTests"
  "OpalBaseTests\\.StoragePersistenceTests/fulcrumSyncThenPersistAndRestore"
  "OpalBaseTests\\.NetworkConfigurationTests/testConnectionToFulcrumServer"
  "OpalBaseTests\\.NetworkConfigurationTests/testConnectFulcrumWithCustomConfiguration"
  "OpalBaseTests\\.NetworkConfigurationTests/testConnectFulcrumUsingBundledBootstrapServers"
)
