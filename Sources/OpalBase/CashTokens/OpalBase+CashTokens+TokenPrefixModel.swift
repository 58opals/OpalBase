// OpalBase.CashTokens+TokenPrefixModel.swift

import Foundation

extension _OpalBase.CashTokens {
    public enum TokenPrefixModel {
        ...
        public static func decode(prefixPlusBytecode: Data) throws -> (tokenData: TokenData?, lockingBytecode: Data) {
            ...
            if hasNonFungibleToken {
                ...
                nonFungibleToken = try NFTModel(capability: capability, commitment: commitment)
            } else {
            ...
            let category = try CategoryIDModel(transactionOrderData: categoryData)
        ...
        private static func decodeCapability(from value: UInt8) throws -> NFTModel.Capability {
            switch value {
            case 0:
                return .none
            case 1:
        ...
        private static func encodeCapabilityValue(from capability: NFTModel.Capability) -> UInt8 {
            switch capability {
            case .none:
                return 0
            case .mutable:
