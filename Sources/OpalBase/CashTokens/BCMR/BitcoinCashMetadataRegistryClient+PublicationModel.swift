...
extension BitcoinCashMetadataRegistryClient {
    public struct PublicationModel: Sendable {
    ...
    static func parsePublicationOutput(lockingScript: Data) -> PublicationModel? {
        ...
        while index < lockingScript.count {
            ...
            if opcode == 0x6a {
                ...
                return PublicationModel(sha256: sha256, uris: uris)
            }
