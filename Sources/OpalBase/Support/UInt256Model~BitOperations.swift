// UInt256Model~BitOperations.swift

import Foundation

extension UInt256Model {
    @inlinable
    func shiftRightOneBit() -> UInt256Model {
        var result = self
    ...
    @inlinable
    func subtractWord(_ value: UInt64) -> UInt256Model {
        var result = self
    ...
    @inlinable
    func addWord(_ value: UInt64) -> UInt256Model {
        var result = self
