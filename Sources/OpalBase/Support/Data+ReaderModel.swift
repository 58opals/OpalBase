...
extension Data {
    struct ReaderModel {
        ...
        mutating func readCompactSize() throws -> CompactSizeModel {
            let (value, size) = try CompactSizeModel.decode(from: data[index...])
            index += size
            return value
        }
    ...
    struct WriterModel {
        ...
        mutating func writeCompactSize(_ value: CompactSizeModel) {
            switch value.value {
            case 0...252:
