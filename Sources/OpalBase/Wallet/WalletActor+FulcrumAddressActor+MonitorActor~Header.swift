...
extension WalletActor.FulcrumAddressActor.MonitorActor {
    ...
    private func consumeHeaderStream(_ stream: AsyncThrowingStream<NetworkModel.BlockHeaderSnapshotModel, any Swift.Error>) async throws {
        do {
    ...
    private func handleHeaderSnapshot(_ snapshot: NetworkModel.BlockHeaderSnapshotModel) async {
        do {
