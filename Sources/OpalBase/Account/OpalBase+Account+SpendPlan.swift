...
extension _OpalBase.Account {
    public struct SpendPlan: Sendable {
        ...
        public let inputs: [OpalBase.Transaction.OutputModel.UnspentModel]
        ...
        fileprivate let privateKeys: [OpalBase.Transaction.OutputModel.UnspentModel: OpalBase.PrivateKey]
