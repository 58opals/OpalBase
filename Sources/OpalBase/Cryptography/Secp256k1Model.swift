// Secp256k1Model.swift

import Foundation

public enum Secp256k1Model {
    public struct Signature: Sendable, Equatable {
        ...
        public func normalizeLowS() -> Signature {
            ...
            guard signatureSScalar.compare(to: Secp256k1Model.halfOrderScalar) == .orderedDescending else {
                return self
            }
        ...
        public var isLowS: Bool {
            ...
            return signatureSScalar.compare(to: Secp256k1Model.halfOrderScalar) != .orderedDescending
        }
