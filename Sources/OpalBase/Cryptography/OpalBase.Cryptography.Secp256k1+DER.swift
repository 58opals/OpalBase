// OpalBase.Cryptography.Secp256k1+DER.swift
    ...
    enum DER {
        static func encodeSignature(r: Data, s: Data) throws -> Data {
            guard r.count == 32, s.count == 32 else {
                throw OpalBase.Cryptography.Secp256k1.Error.invalidSignatureLength(actual: r.count + s.count)
            }
        ...
        static func decodeSignature(_ derEncoded: Data) throws -> (r: Data, s: Data) {
            guard !derEncoded.isEmpty else {
                throw OpalBase.Cryptography.Secp256k1.Error.derMalformed
            }
            var index = 0
        ...
        private static func decodeInteger(from data: Data, startingAt index: inout Int) throws -> Data {
            ...
            if firstByte & 0x80 != 0 {
                throw OpalBase.Cryptography.Secp256k1.Error.derNonCanonical
            }
