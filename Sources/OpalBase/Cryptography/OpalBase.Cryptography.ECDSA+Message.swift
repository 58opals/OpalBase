// OpalBase.Cryptography.ECDSA+Message.swift
...
extension OpalBase.Cryptography.ECDSA.Message {
    static func makeRaw(_ data: Data) -> OpalBase.Cryptography.ECDSA.Message {
        .init(representation: .payload(data: data, hashRounds: 0))
    }
    
    static func makeSingleSHA256(_ data: Data) -> OpalBase.Cryptography.ECDSA.Message {
        .init(representation: .payload(data: data, hashRounds: 1))
    }
    
    static func makeDoubleSHA256(_ data: Data) -> OpalBase.Cryptography.ECDSA.Message {
        .init(representation: .payload(data: data, hashRounds: 2))
    }
    
    static func makeHashing(_ data: Data, rounds: UInt8) throws -> OpalBase.Cryptography.ECDSA.Message {
    ...
    static func makeDigest(_ digest: CryptoKit.SHA256.Digest, hashCount: UInt8 = 1) -> OpalBase.Cryptography.ECDSA.Message {
...
private extension OpalBase.Cryptography.ECDSA.Message {
