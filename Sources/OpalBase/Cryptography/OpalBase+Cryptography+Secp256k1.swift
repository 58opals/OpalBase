// OpalBase+Cryptography+Secp256k1.swift
    ...
    public enum Secp256k1 {
        public struct Signature: Sendable, Equatable {
            ...
            public func encodeDER() throws -> Data {
                try OpalBase.Cryptography.Secp256k1.DER.encodeSignature(r: r, s: s)
            }

            public init(derEncoded: Data) throws {
                let signatureValues = try OpalBase.Cryptography.Secp256k1.DER.decodeSignature(derEncoded)
            ...
            public func normalizeLowS() -> Signature {
                ...
                guard signatureSScalar.compare(to: OpalBase.Cryptography.Secp256k1.halfOrderScalar) == .orderedDescending else {
                    return self
                }
