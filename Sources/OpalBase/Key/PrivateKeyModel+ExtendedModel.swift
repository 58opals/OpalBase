...
extension PrivateKeyModel {
    struct ExtendedModel {
        ...
        init(rootKey: PrivateKeyModel.ExtendedModel.RootModel) {
...
extension PrivateKeyModel.ExtendedModel: Hashable {
    static func == (lhs: PrivateKeyModel.ExtendedModel, rhs: PrivateKeyModel.ExtendedModel) -> Bool {
...
extension PrivateKeyModel.ExtendedModel: CustomDebugStringConvertible {
...
extension PrivateKeyModel.ExtendedModel: Sendable {}
extension PrivateKeyModel.ExtendedModel: Equatable {}
