...
extension MnemonicModel.WordModel {
    ...
    static func detectLanguage(of words: [String]) throws -> MnemonicModel.WordListModel {
    ...
    static func detectLanguage(
        of words: [String],
        wordLists: [LanguageModel: MnemonicModel.WordListModel]
    ) throws -> MnemonicModel.WordListModel {
    ...
    static func validateMnemonicWords(_ words: [String], wordList: MnemonicModel.WordListModel) throws -> Bool {
...
private extension MnemonicModel.WordModel {
    static func loadWordLists() throws -> [LanguageModel: MnemonicModel.WordListModel] {
        var wordListsByLanguage: [LanguageModel: MnemonicModel.WordListModel] = .init()
        for language in LanguageModel.allCases {
            wordListsByLanguage[language] = try MnemonicModel.WordListModel(language: language)
        }
