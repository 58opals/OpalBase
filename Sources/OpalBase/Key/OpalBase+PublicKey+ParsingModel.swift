// OpalBase.PublicKey+ParsingModel.swift
...
extension _OpalBase.PublicKey {
    enum ParsingModel {
        ...
        private static func parseCompressed(_ data: Data) throws -> AffinePointModel {
        ...
        private static func parseUncompressed(_ data: Data) throws -> AffinePointModel {
            guard let prefix = data.first else {
                throw Error.invalidLength(actual: data.count)
            }
