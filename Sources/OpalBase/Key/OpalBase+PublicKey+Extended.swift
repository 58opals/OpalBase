// OpalBase+PublicKey+Extended.swift
...
extension _OpalBase.PublicKey {
    struct Extended {
        ...
        init(extendedPrivateKey: OpalBase.PrivateKey.Extended) throws {
...
extension _OpalBase.PublicKey.Extended: Hashable {
    static func == (lhs: OpalBase.PublicKey.Extended, rhs: OpalBase.PublicKey.Extended) -> Bool {
...
extension _OpalBase.PublicKey.Extended: CustomDebugStringConvertible {
...
extension _OpalBase.PublicKey.Extended {
    private func deriveChildPublicKey(at index: UInt32) throws -> OpalBase.PublicKey.Extended {
    ...
    func deriveChild(at path: OpalBase.DerivationPath) throws -> OpalBase.PublicKey.Extended {
        try deriveChild(at: path.makeIndices())
    }
    
    func deriveChild(at indices: [UInt32]) throws -> OpalBase.PublicKey.Extended {
        ...
        for index in indices.dropFirst(startingDepth) {
            guard !Harden.checkHardened(index) else { throw OpalBase.PublicKey.Error.hardenedDerivation }
...
extension _OpalBase.PublicKey.Extended: Sendable {}
extension _OpalBase.PublicKey.Extended: Equatable {}
