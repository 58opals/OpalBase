...
extension _OpalBase.Mnemonic.Word {
    ...
    static func detectLanguage(of words: [String]) throws -> OpalBase.Mnemonic.WordList {
    ...
    static func detectLanguage(
        of words: [String],
        wordLists: [Language: OpalBase.Mnemonic.WordList]
    ) throws -> OpalBase.Mnemonic.WordList {
    ...
    static func validateMnemonicWords(_ words: [String], wordList: OpalBase.Mnemonic.WordList) throws -> Bool {
...
private extension _OpalBase.Mnemonic.Word {
    static func loadWordLists() throws -> [Language: OpalBase.Mnemonic.WordList] {
        var wordListsByLanguage: [Language: OpalBase.Mnemonic.WordList] = .init()
        for language in Language.allCases {
            wordListsByLanguage[language] = try OpalBase.Mnemonic.WordList(language: language)
        }
