// OpalBase+PrivateKey+Extended.swift
...
extension _OpalBase.PrivateKey {
    struct Extended {
        ...
        init(rootKey: OpalBase.PrivateKey.Extended.Root) {
...
extension _OpalBase.PrivateKey.Extended: Hashable {
    static func == (lhs: OpalBase.PrivateKey.Extended, rhs: OpalBase.PrivateKey.Extended) -> Bool {
...
extension _OpalBase.PrivateKey.Extended: CustomDebugStringConvertible {
...
extension _OpalBase.PrivateKey.Extended: Sendable {}
extension _OpalBase.PrivateKey.Extended: Equatable {}
