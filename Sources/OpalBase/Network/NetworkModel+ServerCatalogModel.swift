// NetworkModel+ServerCatalogModel.swift

import Foundation

extension NetworkModel {
    public struct ServerCatalogModel: Sendable, Equatable {
        ...
        public func listServers(for environment: NetworkModel.EnvironmentModel) -> [URL] {
            switch environment {
            case .mainnet:
...
extension NetworkModel.ServerCatalogModel {
