...
extension _OpalBase.Network {
    public protocol ScriptHashReadableClient: Sendable {
        ...
        func fetchUnspent(forScriptHash scriptHashHex: String, tokenFilter: OpalBase.Network.TokenFilter) async throws -> [OpalBase.Transaction.OutputModel.UnspentModel]
    }
}
