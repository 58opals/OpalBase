// NetworkModel+FulcrumClient.swift
...
extension NetworkModel {
    public actor FulcrumClient {
        ...
        private func failSubscriptions(_ subscriptions: [any FulcrumSubscriptionClient], error: Swift.Error) async {
...
private struct FulcrumMetricsAdapter: SwiftFulcrum.MetricsClient {
    ...
    init(environment: NetworkModel.EnvironmentModel, collector: any NetworkModel.MetricsClient) {
