// BlockModel+HeaderModel+ChainActor.swift
...
extension BlockModel.HeaderModel {
    public actor ChainActor {
        ...
        private var headers: [UInt32: BlockModel.HeaderModel] = .init()
...
extension BlockModel.HeaderModel.ChainActor {
...
extension BlockModel.HeaderModel.ChainActor {
    ...
    func lookupHeader(at height: UInt32) -> BlockModel.HeaderModel? {
        headers[height]
    }
    ...
    func apply(header: BlockModel.HeaderModel, at height: UInt32) throws -> UpdateResult {
