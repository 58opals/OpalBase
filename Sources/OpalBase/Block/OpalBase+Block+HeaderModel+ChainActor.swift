// OpalBase.Block+HeaderModel+ChainActor.swift

import Foundation

extension _OpalBase.Block.HeaderModel {
...
extension _OpalBase.Block.HeaderModel.ChainActor {
    ...
    func lookupHeader(at height: UInt32) -> OpalBase.Block.HeaderModel? {
        headers[height]
    }
    ...
    func apply(header: OpalBase.Block.HeaderModel, at height: UInt32) throws -> UpdateResult {
