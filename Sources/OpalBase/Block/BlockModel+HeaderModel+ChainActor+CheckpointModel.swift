// BlockModel+HeaderModel+ChainActor+CheckpointModel.swift
...
extension BlockModel.HeaderModel.ChainActor.CheckpointModel {
    static var defaultCheckpoint: BlockModel.HeaderModel.ChainActor.CheckpointModel {
