// TransactionModel+HashTypeModel.swift

import Foundation

extension TransactionModel {
    public struct HashTypeModel: Sendable {
        ...
        public static func makeAll(anyoneCanPay: Bool = false,
                                   includesUnspentTransactionOutputs: Bool = false) -> HashTypeModel {
            HashTypeModel(mode: .all,
...
extension TransactionModel.HashTypeModel {
    func validate() throws {
        guard !(isAnyoneCanPay && isUnspentTransactionOutputsEnabled) else {
            throw TransactionModel.Error.unsupportedHashType
        }
