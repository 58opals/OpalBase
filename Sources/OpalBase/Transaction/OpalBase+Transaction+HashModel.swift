// OpalBase+Transaction+HashModel.swift
...
extension _OpalBase.Transaction.HashModel: CustomStringConvertible {
    public var description: String {
        "\(naturalOrder.hexadecimalString) (↔︎: \(reverseOrder.hexadecimalString))"
    }
}

extension _OpalBase.Transaction.HashModel: Sendable {}
extension _OpalBase.Transaction.HashModel: Hashable {}
extension _OpalBase.Transaction.HashModel: Codable {}
