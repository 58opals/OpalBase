// TransactionModel+HashModel.swift
...
extension TransactionModel.HashModel: CustomStringConvertible {
    public var description: String {
        "\(naturalOrder.hexadecimalString) (↔︎: \(reverseOrder.hexadecimalString))"
    }
}

extension TransactionModel.HashModel: Sendable {}
extension TransactionModel.HashModel: Hashable {}
extension TransactionModel.HashModel: Codable {}
