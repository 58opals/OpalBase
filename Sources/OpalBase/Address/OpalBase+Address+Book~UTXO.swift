...
extension _OpalBase.Address.Book {
    func selectUTXOs(targetAmount: OpalBase.Satoshi,
                     ...
                     configuration: CoinSelectionModel.Configuration = .makeTemplateConfiguration()) throws -> [OpalBase.Transaction.OutputModel.UnspentModel] {
    ...
    private func selectUTXOs(targetAmount: OpalBase.Satoshi,
                             feePerByte: UInt64,
                             configuration: CoinSelectionModel.Configuration) throws -> [OpalBase.Transaction.OutputModel.UnspentModel] {
