// AddressModel+BookActor+SpendReservationModel.swift
...
extension AddressModel.BookActor {
    struct SpendReservationModel: Identifiable, Sendable {
        ...
        struct State: Sendable {
            let utxos: Set<TransactionModel.OutputModel.UnspentModel>
...
extension AddressModel.BookActor {
    func reserveSpend(utxos: [TransactionModel.OutputModel.UnspentModel],
                      changeEntry: EntryModel,
                      tokenSelectionPolicy: AddressModel.BookActor.CoinSelectionModel.TokenSelectionPolicy) async throws -> SpendReservationModel {
